                ...
                RegisterComponent.prototype.onSubmit = function () {
                    ...
                    if (this.registerForm.get('customCaptcha').value == this.random) {
                        ...
                        this.authService.RegisterWithEmail(user_1)
                            ...
                            _this.logService.persistirMovimiento(user_1, src_app_models_log__WEBPACK_IMPORTED_MODULE_8__["TargetMovimiento"].usuario, src_app_models_log__WEBPACK_IMPORTED_MODULE_8__["TipoMovimiento"].alta, mensaje);
